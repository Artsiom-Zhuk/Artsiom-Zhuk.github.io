...
const MainPage = ({
  person: { name, titlePhoto, birthDate },
  goToPersonPage
}) => (
  <div>
    <div className="main-page__div-background">
      <div className="main-page__div-wrapper">
        <div className="main-page__div-container-title-artist-day">
          <h1>
            <Badge className="main-page__badge-title-artist-day" color="dark">
              Фотограф дня
            </Badge>
          </h1>
        </div>
        <Media className="main-page__media-container-artist-day">
          <div className="main-page__div-container-image-artist">
            <Media left href="#">
              <Media
                className="main-page__media-image-artist"
                object
                src={bazan_3}
          ...
          <div className="main-page__div-about-artist">
            <Media body>
              ...
              <Button
                className="main-page__button-more"
        ...
        <div className="main-page__div-container-about-portal">
          <h4>О портале</h4>
          <div>
            Портал содержит информацию о жизни и творчести выдающихся фотогрофов
            Беларуси.
          </div>
        </div>
        <div className="main-page__div-container-team-project">
          ...
          <div className="main-page__div-team-project">
            <div className="main-page__div-developer">
              ...
              <div className="main-page__div-name-developer">Владислав</div>
              <div>
            ...
            <div className="main-page__div-developer">
              ...
              <div className="main-page__div-name-developer">Анатолий</div>
              <div>
            ...
            <div className="main-page__div-developer">
              ...
              <div className="main-page__div-name-developer">Павел</div>
              <div>
            ...
            <div className="main-page__div-developer">
              ...
              <div className="main-page__div-name-developer">Артём</div>
              <div>
